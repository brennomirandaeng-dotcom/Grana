  ...
  return (
    <AuthShell>
      <div className="space-y-1 mb-8">
        ...
        <p className="text-sm text-muted-foreground">Comece a organizar suas finanças em poucos segundos.</p>
      </div>

      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <Label htmlFor="name">Nome completo</Label>
          <Input id="name" required autoFocus value={name} onChange={(e) => setName(e.target.value)} placeholder="Seu nome" />
        </div>
        <div>
